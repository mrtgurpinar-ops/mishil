# Mışıl Baby - Apple App Store Connect Mağaza Listeleme (ASO)

Bu doküman, Apple App Store Connect'te **Mışıl Baby (iOS)** için gerekli tüm mağaza metinlerini, anahtar kelimeleri ve yasal feragatnameleri içerir.
...
| Alan Adı | Değer |
| :--- | :--- |
| **Uygulama Adı (App Name):** | `Mışıl Baby: Bebek Uyku & Ses` *(30 Karakter Sınırı)* |
| **Alt Başlık (Subtitle):** | `AI Ağlama Analizi & Beyaz Gürültü` *(30 Karakter Sınırı)* |
| **Birincil Kategori:** | `Tıp & Sağlık` (Medical / Health & Fitness) veya `Yaşam Tarzı` (Lifestyle) |
| **İkincil Kategori:** | `Müzik` (Music & Audio) |
| **Bundle ID:** | `com.levitas.misilbaby` |
| **SKU:** | `LEVITAS-MISIL-001` |

---

## 2. ASO Anahtar Kelimeleri (Keywords - Maksimum 100 Karakter)
```text
bebek uyku,beyaz gürültü,ağlama analizi,kolik bebek,ninni,pışpış,fön sesi,uyku takibi,gece lambası
```

---

## 3. Promosyon Metni (Promotional Text - 170 Karakter):
```text
Mışıl Baby ile bebeğiniz mışıl mışıl uyusun! Yapay zekâ destekli ağlama analizi, 16+ stüdyo kaydı beyaz gürültü ve kişiye özel uyku rutinleri tek uygulamada.
```
